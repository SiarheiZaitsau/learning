           ...
           <div className={styles.header}> 
            ...
            <ul className={styles.eventsList}>
                <li className={styles.event}>
                    ...
                    <h3 className={styles.eventTitle}> Конференция по лечению тяжелых форм акне изотретиноином</h3>
                    ...
                    <ul className={styles.findList}>
                        ...
                        <li className={styles.findItem}>
                            ...
                            <p className={styles.eventFind}>Институт Прикладной Эстетики «Лаки Хаус», Ростов-на-Дону</p>
                        </li>
                    </ul>
                </li>
                <li className={styles.event}>
                    <p className={styles.eventStatus}> Offline</p>
                    <h3 className={styles.eventTitle}> Акне. Лечение и базовый уход. VIII Научно-практическая конференция дерматовенерологов и косметологов</h3>
                    <p className={styles.text}> Акне является одним из наиболее часто встречающихся заболеваний в практике врача дерматовенеролога и косметолога. Широкая распространенность заболевания, его значительное влияние на качество жизни больных обусловливают необходимость разработки…</p>
                    <ul className={styles.findList}>
                        <li className={styles.findItem}>
                            <img src={Shedule} className={styles.icon}/>
                            <p className={styles.eventFind}>17 - 25 января 2018</p>
